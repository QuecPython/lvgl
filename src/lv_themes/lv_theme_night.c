...
static void basic_init(void)
{
    ...
    bg.text.color      = LV_COLOR_WHITE;	//lv_color_hsv_to_rgb(_hue, 5, 95);
    bg.text.font       = _font;
    ...
    panel.body.main_color     = LV_COLOR_BLACK; //lv_color_hsv_to_rgb(_hue, 11, 18);
    panel.body.grad_color     = LV_COLOR_BLACK; //lv_color_hsv_to_rgb(_hue, 11, 18);
    panel.body.radius         = 0;	//LV_DPI / 20;
